  ...
  onButtonClick() {
    if (!this.isEditing) {
      ...
      if (this.restaurant.openTime && this.restaurant.closedTime) {
        this.openTimeModel = DateUtils.fromLocalTimeStringToDate(this.restaurant.openTime);
        this.closedTimeModel = DateUtils.fromLocalTimeStringToDate(this.restaurant.closedTime);
      }
    } else {
